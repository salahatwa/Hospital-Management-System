...
public class PharmatiestListener {
    ...
    private Object[] initializeBeanArray(SelledDrug selledDrug) {
        ...
        for (int i = 0; i < allSelledDrugForEmployee.size(); i++) {
            ...
            p.setAge(allSelledDrugForEmployee.get(i).getPatient().getAge());
            ...
            p.setDrug_expired(allSelledDrugForEmployee.get(i).getDrug().getDrug_expired());
            p.setStartDate(allSelledDrugForEmployee.get(i).getDrug().getStartDate());
            p.setQuantity(allSelledDrugForEmployee.get(i).getQuantity());
            p.setUnitPerDay(allSelledDrugForEmployee.get(i).getDrug().getUnitPerDay());
