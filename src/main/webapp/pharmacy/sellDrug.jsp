                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right"><a
                                                            ...
                                                            <a
                                                                ...
                                                                rel="tooltip" title="Report" class="btn btn-round btn-fill btn-info" target="_blank" 
                                                                > invoice
                                                            </a></td>
                                                    </tr>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:when test="${ not empty param['usdrug'] }">
                                                    ...
                                                    <form action="Process?action=UpdateSellDrug" method="POST">
                                                        <input type="hidden" name="selledDrugID" value="<%=selledDrugID%>" />
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label>Drug <small>(required)</small></label> <select
                                                                    ...
                                                                    <option value="<%=drug.getDrugId()%>"
                                                                            <%if (selledDrug.getDrug().getDrugId() == drug.getDrugId()) {
                                                                                                                                                        out.print("selected");
                                                                                                                                                    }%>>
                                                                        <%=drug.getName()%> /
                                                                        <%=drug.getCost()%>
